    ...
    <div class="body_resize">
      ...
      <div class="loginRegister">      
          <form id="register" class="formoid-default-green" style="font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#005500;max-width:480px;min-width:150px" method="post" action="register">
            ...
            <div class="element-input"  title="Əsl adınızı daxil edin"><input class="large" type="text" name="name" placeholder="Adınız" /></div>
            <div class="element-input"  title="Əsl soyadınızı daxil edin"><input class="large" type="text" name="surname" placeholder="Soyadınız" /></div>
            ...
            <div class="element-password"  title="Etibarlı şifrə seçin"><input id="password" class="large" type="password" name="password" value="" placeholder="Şifrəniz" /></div>
            <div class="element-password"  title="Şifrənizi yenidən daxil edin"><input class="large" type="password" name="passwordConfirmation" value="" placeholder="Şifrənizi yenidən daxil edin" /></div>
